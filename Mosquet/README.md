...
## V37.5.6 — Visibilidad de solicitudes realizadas
- El filtro de gestión inicia en `Todas`, para que una solicitud no desaparezca al marcarla como realizada/entregada.
- `Pendientes` y `Realizadas` siguen disponibles como filtros explícitos.
- Limpiar filtros vuelve a `Todas`.
- No se modificó la lógica de guardado, Supabase, historial, Archivo ni los estados.
- Sin SQL.
